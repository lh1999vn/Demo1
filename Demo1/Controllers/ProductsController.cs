...
namespace Demo1.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(Demo1Context context)
        {
            _context = context;
        }
        ...
        {
            var demo1Context = _context.Product.Include(p => p.category);
            return View(await demo1Context.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Demo1Context.Product'  is null.");
            }
            var product = await _context.Product.FindAsync(id);
            if (product != null)
            {
